...
class Count:
    ...
    def __checkRisingEdge(self):
        prev_state = GPIO.input(self.__Channel)
        for _ in range(5):
            sleep(0.01)  # Wait for 10 ms
            current_state = GPIO.input(self.__Channel)
